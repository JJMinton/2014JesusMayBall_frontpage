	...
	<div id="small" class="smallBody" style="visibility: hidden;">
		<div id="smallBody">
			...
			<div style="width: 300px; margin: auto;	text-align: center;">
				<a href="http://www.coldplace.co.uk"><img id="ent1" src="media/ent1.png" class="smlAct" alt="Act 1" style="border:0;"/></a>
				<a href="http://antarcticmonkeys.com/am/Home.html"><img id="ent2" src="media/ent2.png" class="smlAct" alt="Act 2" style="border:0;"/></a>
				<a href="http://jamesacaster.com"><img id="ent3" src="media/ent3.png" class="smlAct" alt="Act 3" style="border:0;"/></a>
				<a href="http://petejohansson.com"><img id="ent4" src="media/ent4.png" class="smlAct" alt="Act 4" style="border:0;"/></a>
				<a><img id="ent5" src="media/ent5.png" class="medAct" alt="Act 5" style="border:0;"/></a>
				<a><img id="ent6" src="media/ent6.png" class="medAct" alt="Act 6" style="border:0;"/></a>
				<a><img id="ent7" src="media/ent7.png" class="medAct" alt="Act 7" style="border:0;"/></a>
				<a><img id="ent8" src="media/ent8.png" class="bigAct" alt="Act 8" style="border:0;"/></a>
				<a><img id="ent9" src="media/ent9.png" class="bigAct" alt="The Headliner" style="border:0;"/></a>
			</div>
		...
		<div id="lineup" class="page">
			...
			<div class="columns">
				<div id="left" class="three-column">
					...
					<a> <img id="ent8" src="media/ent8.png" class="medAct" alt="Act 7" style="border:0;"/></a>
					</div>
					<div class="imageContainer">
					<a href="http://www.jamesacaster.com"><img id="ent3" src="media/ent3.png" class="smlAct" alt="Act 3" style="border:0;" /></a>
					</div>
					<div class="imageContainer">
					<a><img id="ent5" src="media/ent5.png" class="medAct" alt="Act 5" style="border:0;"/></a>
					</div>					
				...
				<div id="center" class="three-column">
					<div class="imageContainer">
					<a href="http://www.coldplace.co.uk"><img id="ent1" src="media/ent1.png" class="smlAct" alt="Coldplace" style="border:0;"/></a>
					</div>
					<div class="imageContainer">
					<a><img id="ent9" src="media/ent9.png" class="bigAct" alt="The Headliner" style="border:0;"/></a>
					</div>
					<div class="imageContainer">
					<a href="http://www.antarcticmonkeys.com/am/Home.html"><img id="ent2" src="media/ent2.png" class="smlAct" alt="Antarctic Monkeys" style="border:0;"/></a>
					</div>					
				</div>
				<div id="right" class="three-column">
					<div class="imageContainer">
					...
					<div class="imageContainer">
					<a href="http://www.petejohansson.com"><img id="ent4" src="media/ent4.png" class="smlAct" alt="Act 4" style="border:0;"/></a>
					</div>
					<div class="imageContainer">
					<a><img id="ent7" src="media/ent7.png" class="medAct" alt="Act 6" style="border:0;"/></a>
					</div>					
				</div>					
			</div>
			<div class="columns">
