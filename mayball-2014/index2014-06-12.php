	...
	<div id="small" class="smallBody" style="visibility: hidden;">
		<div id="smallBody">
			...
			<div style="width: 300px; margin: auto;	text-align: center;">
				...
				<a target="_blank" ><img id="ent8" src="media/ent8.png" class="bigAct" alt="Act 8" style="border:0;"/></a>
		...
		<div id="lineup" class="page">
			...
			<div class="columns">
				<div id="left" class="three-column">
					...
					<a target="_blank"> <img id="ent8" src="media/ent8.png" class="medAct" alt="Act 8" style="border:0;"/></a>
					</div>
					<div class="imageContainer">
