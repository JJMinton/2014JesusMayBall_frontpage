	...
	<div id="small" class="smallBody" style="visibility: hidden;">
		<div id="smallBody">
			...
			<div style="width: 300px; margin: auto;	text-align: center;">
				<img id="ent1" src="media/ent1.png" class="smlAct" alt="Act 1" />
				<img id="ent2" src="media/ent2.png" class="smlAct" alt="Act 2" />
				<img id="ent3" src="media/ent3.png" class="smlAct" alt="Act 3" />
				<img id="ent4" src="media/ent4.png" class="smlAct" alt="Act 4" />
				<img id="ent5" src="media/ent5.png" class="medAct" alt="Act 5" />
				<img id="ent6" src="media/ent6.png" class="medAct" alt="Act 6" />
				<img id="ent7" src="media/ent7.png" class="medAct" alt="Act 7" />
				<img id="ent8" src="media/ent8.png" class="bigAct" alt="Act 8" />
				<img id="ent9" src="media/ent9.png" class="bigAct" alt="The Headliner" />
			</div>
		...
		<div id="lineup" class="page">
			...
			<div class="columns">
				<div id="left" class="three-column">
					...
					<img id="ent8" src="media/ent8.png" class="medAct" alt="Act 7" />
					</div>
					<div class="imageContainer">
					<img id="ent3" src="media/ent3.png" class="smlAct" alt="Act 3" />
					</div>
				...
				<div id="right" class="three-column">
					...
					<div class="imageContainer">
					<img id="ent7" src="media/ent7.png" class="medAct" alt="Act 6" />
					</div>					
				</div>					
			</div>
			<div class="columns">
